...
BLECharacteristic GyroscopeData("af787f46-09be-11ee-be56-0242ac120002", BLERead | BLENotify, 20);
BLECharacteristic MagnetometerData("c8fd1904-09be-11ee-be56-0242ac120002", BLERead | BLENotify, 20);
BLECharacteristic OrientationData("57c1b046-09bf-11ee-be56-0242ac120002", BLERead | BLENotify, 20);
...
void setup() {
  ...
  BLE.setDeviceName("SENSPORT");
  BLE.setLocalName("SENSPORT");	
